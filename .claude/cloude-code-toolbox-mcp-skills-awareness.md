...
_Generated: 2026-09-13T19:34:23.437Z_
...
Workspace `mcp.json` _(folder: gokv)_

- **e:\Codes\git\git-practice\gokv\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Administrator\.claude.json** — _File missing_
